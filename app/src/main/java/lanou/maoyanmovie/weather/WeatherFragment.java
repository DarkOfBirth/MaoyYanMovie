...
public class WeatherFragment extends BaseFragment {
    ...
    private void loadBgData() {
        mBgMap = new HashMap<>();
        mBgMap.put("cloudy", new int[]{R.mipmap.bg_cloudy, R.mipmap.bg_cloudy_left, R.mipmap.bg_cloudy_right});
        mBgMap.put("pmdirt", new int[]{R.mipmap.bg_pmdirt, R.mipmap.bg_pmdirt_left, R.mipmap.bg_pmdirt_right});
        ...
        mIcon = new HashMap<>();
        mIcon.put("1",R.mipmap.icon_cloudy);
        mIcon.put("18",R.mipmap.icon_fog);
        mIcon.put("7",R.mipmap.icon_ice_rain);
        mIcon.put("33",R.mipmap.icon_pm_dirt);
        mIcon.put("-1",R.mipmap.icon_middle_sand);
        mIcon.put("13",R.mipmap.icon_middle_snow);
        mIcon.put("0", R.mipmap.icon_sunny);
        mIcon.put("2",R.mipmap.icon_overcast);
    }
    ...
    private void setLifeAdvice() {
        ...
        wearContentLifeTv.setText(mWeatherBean.getResult().getLife().getInfo().getChuanyi().get(0));
    }
    ...
    private void setThreeDayForecast() {
        ...
        todayQuality.setText(mWeatherBean.getResult().getWeather().get(0).getInfo().getDay().get(1));
       ...
       tommorowQuality = bindView(tommorowView,R.id.quality_forecast_tv);
        ...
        tommorowQuality.setText(mWeatherBean.getResult().getWeather().get(1).getInfo().getDay().get(1));
        ...
        thirdQuality.setText(mWeatherBean.getResult().getWeather().get(2).getInfo().getDay().get(1));
