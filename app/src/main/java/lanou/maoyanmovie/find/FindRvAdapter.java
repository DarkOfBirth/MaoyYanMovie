...
public class FindRvAdapter extends RecyclerView.Adapter<FindRvAdapter.FindViewHolder> {
    ...
    private FindViewHolder mViewHolder;
    ...
    public void onBindViewHolder(FindViewHolder holder, int position) {
        ...
        switch (mFindTodayBean.getData().getFeeds().get(position).getStyle()){
            case 2:
                ...
                Glide.with(mContext).load(mFindTodayBean.getData().getFeeds().get(position).getImages().get(0).getUrl()).into(holder.findTwoImage);
                break;
            case 3:
                ...
                Glide.with(mContext).load(mFindTodayBean.getData().getFeeds().get(position).getImages().get(0).getUrl()).into(holder.findThirdImagesOneImg);
                Glide.with(mContext).load(mFindTodayBean.getData().getFeeds().get(position).getImages().get(1).getUrl()).into(holder.findThirdImagesTwoImg);
                Glide.with(mContext).load(mFindTodayBean.getData().getFeeds().get(position).getImages().get(2).getUrl()).into(holder.findThirdImagesThirdImg);
                break;
        }
    }
