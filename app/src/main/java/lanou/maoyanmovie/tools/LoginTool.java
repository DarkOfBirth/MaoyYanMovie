...
public final class LoginTool {
    //Mob
    public static final String APP_KEY = "196ae98dfc06e";
    public static final String APP_SECRETE = "9b494479284d7a3715079ceca4da97ab";
    //Bmob
    ...
    public static boolean judgePhoneNum(String phoneNum) {
        if (isMatchLength(phoneNum, 11) && isMobileNO(phoneNum)) {
            ...
            Toast.makeText(MyApplication.getmContext(), "手机号码输入有误", Toast.LENGTH_SHORT).show();
            return false;
        }
    }
